...
- Menu-bar state must remain understandable through labels and menu copy; route status-item ownership details to the global `macos-app-engineering` skill and this project's overlay.
