...
enum SettingsSearchIndex {
    ...
    private static let prefixMappings: [PrefixSectionMapping] = [
        ...
        .init(prefix: "settings.section.rules_per_app", section: .rulesPerApp),
        .init(prefix: "settings.rules_per_app", section: .rulesPerApp),
        .init(prefix: "settings.styles.", section: .rulesPerApp),
