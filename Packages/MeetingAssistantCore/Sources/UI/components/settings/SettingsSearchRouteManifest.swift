...
enum SettingsSearchRouteManifest {
    ...
    static let prefixRoutes: [PrefixRoute] = [
        ...
        .init(prefix: "settings.section.assistant", section: .modes),
        .init(prefix: "settings.assistant.", section: .modes),
        .init(prefix: "settings.integrations.", section: .modes),
        ...
        .init(prefix: "settings.section.history", section: .history),
        .init(prefix: "settings.transcriptions.", section: .history),
        ...
        .init(prefix: "transcription.qa.", section: .history),
        .init(prefix: "settings.section.models", section: .models),
        .init(prefix: "settings.models.", section: .models),
        .init(prefix: "settings.section.vocabulary", section: .dictionary),
        .init(prefix: "settings.vocabulary.", section: .dictionary),
        .init(prefix: "settings.section.dictionary", section: .dictionary),
        .init(prefix: "settings.dictionary.", section: .dictionary),
        ...
        .init(prefix: "settings.updates.", section: .updates),
    ]
