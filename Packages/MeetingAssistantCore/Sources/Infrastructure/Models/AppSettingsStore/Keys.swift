...
extension AppSettingsStore {
    enum Keys {
        ...
        static let meetingNotesHotkeyEnabled = "meetingNotesHotkeyEnabled"
        static let meetingNotesTranslucentPanel = "meetingNotesTranslucentPanel"
        static let meetingNotesShowOnAllSpaces = "meetingNotesShowOnAllSpaces"
        static let meetingNotesHideFromScreenCapture = "meetingNotesHideFromScreenCapture"
        static let meetingNotesAutoSizeHeight = "meetingNotesAutoSizeHeight"
        static let meetingNotesEditorTheme = "meetingNotesEditorTheme"
        static let meetingNotesTextSize = "meetingNotesTextSize"
        static let meetingNotesLastEditedCalendarEventIdentifier = "meetingNotesLastEditedCalendarEventIdentifier"
        static let ignoredCalendarEventIdentifiers = "ignoredCalendarEventIdentifiers"
        static let meetingRemindersEnabled = "meetingRemindersEnabled"
        static let meetingReminderLeadMinutes = "meetingReminderLeadMinutes"
        static let meetingReminderOverlayLeadSeconds = "meetingReminderOverlayLeadSeconds"
        static let meetingReminderOverlayEnabled = "meetingReminderOverlayEnabled"
        static let meetingReminderAlertSoundEnabled = "meetingReminderAlertSoundEnabled"
        static let meetingReminderMirrorAllScreens = "meetingReminderMirrorAllScreens"
        static let meetingReminderDismissedEventKeys = "meetingReminderDismissedEventKeys"
