...
# ponytail: serialize the Xcode lane while tests share process-wide stores;
# opt into parallelism only after those stores have per-test isolation.
SERIAL_XCODE_TESTS="${MA_SERIAL_XCODE_TESTS:-1}"
