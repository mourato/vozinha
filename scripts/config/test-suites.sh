...
TEST_SUITE_DEV_SKIP_REGEX='testPerformance_|SummaryBenchmarkRegressionTests|AssistantOverlayLifecycleTests|DictionaryQuickAddPanelControllerTests|AudioSystemTests|AudioRecordingWorkerTests|RecordingManagerTests|ConcurrencyTests|MemorySanityTests|AssistantIndicatorActionWiringTests'
